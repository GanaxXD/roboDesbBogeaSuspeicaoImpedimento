-- CONCLUSOS
	...
	AND DESCRICAO_TIPO_ARQUIVO.DESCRICAO = 'Petição Inicial'
	...
	(
		...
		WHERE  p2.NUMEROPROCESSO= PROCESSO.NUMEROPROCESSO AND TIPO_LOCALIZADOR.codvara = 0
	)
	UNION 
	--DISTRIBUIDOS
	SELECT 
	...
	AND	TRUNC(PROCESSO.DATARECEBIMENTO) > SYSDATE-3
